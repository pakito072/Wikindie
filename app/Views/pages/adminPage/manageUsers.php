							...
							<div class="card">
								...
								<div class="card-header border-0 pt-6">
									...
									<div class="card-toolbar">
										...
										<!--begin::Export-->
										<form method="get" action="<?= base_url('manageUsers/export') ?>" id="exportForm">
											<input type="hidden" name="username" value="<?= esc($filters['username']) ?>">
											<input type="hidden" name="email" value="<?= esc($filters['email']) ?>">
