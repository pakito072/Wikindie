											...
											<div class="mb-10">
												...
												<div>
													<select class="form-select form-select-solid" data-kt-select2="true"
														data-placeholder="Select option" data-dropdown-parent="#kt_menu_61484c5528c3d"
						...
						<div id="kt_content_container" class="container-xxl">
							...
							<div class="card">
								...
								<div class="card-body pt-0">
									<!--begin::Table-->
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_guides">
										<!--begin::Table head-->
										<thead>
											<!--begin::Table row-->
													...
													<td class="text-end">
														...
														<div
															...
															<div class="menu-item px-3">
																<a href="<?= base_url('guides/view/' . $guide['id']) ?>" class="menu-link px-3">View</a>
															</div>
															<div class="menu-item px-3">
																<a href="#" class="menu-link px-3" data-kt-guides-table-filter="delete_row">Delete</a>
															</div>
														</div>
													</td>
													<!--end::Action-->
